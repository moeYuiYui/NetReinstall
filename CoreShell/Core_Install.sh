...
[[ "$ddMode" == '1' ]] && {
  export SSL_SUPPORT='https://cdn.jsdelivr.net/gh/moeYuiYui/NetReinstall@1.0.0/CoreFiles/wget_udeb_amd64.tar.gz';
  if [[ -n "$tmpURL" ]]; then
    DDURL="$tmpURL"
...
[[ -z "$myPASSWORD" ]] && myPASSWORD='$1$6E2OCdRd$In7GnFnTjBN8KKiOGOlaP0';
